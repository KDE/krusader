        ...
        KonfiguratorPage(first, parent), offset(0)
{
    ...
    {{"Colors", "KDE Default",                 _KDEDefaultColors,      i18n("Use the default KDE colors"),             false,  "<p><img src='toolbar|kcontrol'></p>" + i18n("<p>Use KDE's global color configuration.</p><p><i>KDE System Settings -> Appearance  -> Colors</i></p>") },

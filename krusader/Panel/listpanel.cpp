...
#define SERVICE_LIST_ID  200
  ...
  { // meaningful only if one file is selected
...
void ListPanel::keyPressEvent( QKeyEvent *e )
{
  switch ( e->key() )
  {
      ...
      { // user pressed CTRL+Right/Left - refresh other panel to the same path as this one
